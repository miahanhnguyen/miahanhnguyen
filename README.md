...
|------------|-------|--------|
|[TikTok engagement prediction model](https://github.com/miahanhnguyen/TikTok-engagement-prediction/blob/main/TikTok%20engagement%20analysis.pdf)|Machine learning|Engineered a TikTok engagement prediction model, leveraging machine learning and advanced feature engineering to identify key factors influencing user interaction and optimize content strategies. Developed a sentiment analysis framework to assess caption sentiment and its impact on user engagement, driving actionable insights for content optimization.|
...
|Project name| Skills| Summary|
|------------|-------|--------|
|Retail sales performance dashboard|Data visualisation, DAX calculations, KPI tracking, interactive reporting|Designed a dynamic Power BI dashboard to analyze sales performance across different regions, product categories, and customer segments. Integrated data from multiple sources, created interactive visualizations, and implemented key performance indicators (KPIs) to track revenue, profit margins, and sales trends. Enabled stakeholders to identify growth opportunities and optimize pricing strategies.|

## Excel
|Project name| Skills| Summary|
|------------|-------|--------|
|Automated PCR data validation template|Excel automation, data extraction, logical testing, advanced formulas, structured data processing|Developed an Excel template to automate the extraction and validation of PCR run results from raw data files. Used advanced functions like FILTER, INDEX, MATCH, OFFSET, UNIQUE, LAMBDA, and IF to efficiently process data and assess result validity. Implemented dynamic formulas and structured naming conventions to streamline workflows, reduce manual errors, and improve decision-making based on test outcomes. This solution enhanced efficiency and accuracy in data analysis, making complex PCR result validation more accessible.|
