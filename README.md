...
|------------|-------|--------|
|Data Mart - Sales impact of sustainability changes|SQL|An online supermarket specialising in fresh produce transitioned to fully sustainable packaging across its supply chain. The task is to analyse the impact of this change on sales performance across different platforms, regions, segments, and customer types. The key objectives are to quantify the effects of the sustainability shift, identify the most impacted areas, and develop strategies to minimise potential disruptions from future sustainability initiatives.|
...
|Clique Bait - E-commerce funnel analysis|SQL|This case study focuses on analysing customer behavior by calculating funnel fallout rates for the Clique Bait online store. The goal is to identify where potential customers drop off in the purchasing process and develop strategies to improve conversion rates.|
|Balanced Tree Clothing - Sales performance analysis|SQL|A fashion brand focused on providing optimised clothing and lifestyle wear for modern adventurers. The task is to analyse sales performance and generating a financial report to provide insights for the merchandising team and share key financial metrics with the broader business.|
|Fresh Segments - Customer interest analysis|SQL| A digital marketing agency specialises in analysing online ad click behavior for businesses. The goal is to analysing client’s aggregated data to derive high-level insights into customer interests and behavior.|
## Python
